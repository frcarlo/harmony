              ...
              <div v-if="accessUser?.id === u.id" class="px-4 pb-4">
                ...
                <v-card variant="tonal" rounded="lg" class="pa-3 mb-3">
                  <div class="d-flex align-center ga-3 flex-wrap">
                    ...
                    <div class="flex-grow-1" style="min-width: 0">
                      <div class="text-body-2 font-weight-bold">{{ t('users.force_device_type_label') }}</div>
                      <div class="text-caption text-medium-emphasis">{{ t('users.force_device_type_hint') }}</div>
                    </div>
                    <div class="d-flex ga-1">
                      <v-chip
                        v-for="dt in [{ value: null, label: t('users.device_auto') }, { value: 'desktop', label: t('toolbar.device_desktop') }, { value: 'tablet', label: t('toolbar.device_tablet') }, { value: 'mobile', label: t('toolbar.device_mobile') }]"
                        :key="String(dt.value)"
                        size="small"
