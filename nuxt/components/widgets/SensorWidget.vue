<template>
  <div class="h-100 d-flex flex-column pa-4" style="cursor: pointer" @click="dialogOpen = true">
    <div class="d-flex align-center ga-2 mb-2">
      <v-icon icon="mdi-pulse" size="14" color="medium-emphasis" />
    ...
    <div v-if="entity?.last_updated" class="text-caption" style="opacity:0.4">{{ formatTime(entity.last_updated) }}</div>
  </div>
